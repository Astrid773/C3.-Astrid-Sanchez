...
<!------------------------------------------- Form box ---------------------------------------------->	
		<div class="form-box">
            ...
            <div class="login-container" id="login">
				...
				<form class="registro" action="guardar.php" method="POST"
        		id="contact_form" runat="server" enctype="multipart-form-
        		data">
                <div class="input-box">
			...
			<div class="register-container" id="register">
				...
				<div class="two-forms">
					...
					<div class="input-box">
						<input type="text" class="input-field" id="Apellidos" name="Apellidos" placeholder="Appellido"
						maxlength="60" required><br>
						<i class="bx bx-user"></i>
					</div>
				</div>
